...
<head>
    ...
    <!-- Google Fonts -->
    <link
        href="{{ asset('/tampilan/https://fonts.googleapis.com/css?family=https://fonts.googleapis.com/css?family=Inconsolata:400,500,600,700|Raleway:400,400i,500,500i,600,600i,700,700i') }}"
        rel="stylesheet">
...
<body>
    ...
    <nav class="navbar navbar-light custom-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">Bandung Pride</a>
...
{{-- <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
                        <a href="work-single.html" class="item-wrap fancybox">
                            ...
                            <img class="img-fluid" src="{{ asset('/tampilan/assets/img/img_3.jpg') }}">
                        </a>
                    </div>
                    <div class="item design col-sm-6 col-md-4 col-lg-4 mb-4">
                        <a href="work-single.html" class="item-wrap fancybox">
                            ...
                            <img class="img-fluid" src="{{ asset('/tampilan/assets/img/img_4.jpg') }}">
                        </a>
                    </div>
                    <div class="item photography col-sm-6 col-md-4 col-lg-4 mb-4">
                        <a href="work-single.html" class="item-wrap fancybox">
                            ...
                            <img class="img-fluid" src="{{ asset('/tampilan/assets/img/img_5.jpg') }}">
                        </a>
                    </div>
                    <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
                        <a href="work-single.html" class="item-wrap fancybox">
                ...
                <div class="row">
                    <div class="col-4 col-sm-4 col-md-2">
                        <a href="#" class="client-logo"><img
                                src="{{ asset('/tampilan/assets/img/logo-adobe.png') }}" alt="Image"
                                class="img-fluid"></a>
                    </div>
                    <div class="col-4 col-sm-4 col-md-2">
                        <a href="#" class="client-logo"><img
                                src="{{ asset('/tampilan/assets/img/logo-uber.png') }}" alt="Image"
                                class="img-fluid"></a>
                    </div>
                    <div class="col-4 col-sm-4 col-md-2">
                        <a href="#" class="client-logo"><img
                                src="{{ asset('/tampilan/assets/img/logo-apple.png') }}" alt="Image"
                                class="img-fluid"></a>
                    </div>
                    <div class="col-4 col-sm-4 col-md-2">
                        <a href="#" class="client-logo"><img
                                src="{{ asset('/tampilan/assets/img/logo-netflix.png') }}" alt="Image"
                                class="img-fluid"></a>
                    </div>
                    <div class="col-4 col-sm-4 col-md-2">
                        <a href="#" class="client-logo"><img
                                src="{{ asset('/tampilan/assets/img/logo-nike.png') }}" alt="Image"
                                class="img-fluid"></a>
                    </div>
                    <div class="col-4 col-sm-4 col-md-2">
                        <a href="#" class="client-logo"><img
                                src="{{ asset('/tampilan/assets/img/logo-google.png') }}" alt="Image"
                                class="img-fluid"></a>
                    </div>
