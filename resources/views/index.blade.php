        ...
        <div class="container">
            <div class="row mb-5 align-items-center">
                <div class="col-md-12 col-lg-6 mb-4 mb-lg-0" data-aos="fade-up">
                    ...
                    <h2>Temukan Destinasi Wisata Anda Disini</h2>
                    <h5>Temukan berbagai wisata menarik untuk dikunjungi</h5>
                </div>
                    ...
                    <div class="item {{ $data->kategori->nama }} col-sm-6 col-md-4 col-lg-4 mb-4">
                        <a href="wisata/{{ $data->slug }}" class="item-wrap fancybox">
                            <div class="work-info">
                                ...
                                <span>{{ $data->Kategori->nama }}</span><br>
            ...
            <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial">
                                <img src="{{ asset('tampilan/assets/img/pr_1.jpg') }}" alt="Image" class="img-fluid">
                                <blockquote>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial">
                                <img src="{{ asset('tampilan/assets/img/pr_2.jpg') }}" alt="Image" class="img-fluid">
                                <blockquote>
                                    <p>Situs ini sangat berguna sekali.Ketika saya pertama kali berkunjung ke Bandung saya
                                        bingung akan berlibur kemana,lalu saya menemukan website ini dengan segala macam
                                        wisata ada disana.</p>
