...
class Wisata extends Model
{
    ...
    protected $visible = ['kategori_id', 'nama_wisata', 'alamat', 'deskripsi', 'tiket', 'fasilitas', 'biro_id', 'cover'];

    protected $fillable = ['kategori_id', 'slug', 'nama_wisata', 'alamat', 'deskripsi', 'tiket', 'fasilitas', 'slug', 'biro_id', 'cover'];
